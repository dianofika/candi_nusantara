 ...
 */
public class candi_sewu extends javax.swing.JFrame {

    /**
     * Creates new form candi_sewu
     */
    public candi_sewu() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(candi_sewu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new candi_sewu().setVisible(true);
            }
        });
    }
